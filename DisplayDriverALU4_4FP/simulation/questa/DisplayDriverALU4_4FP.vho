...
-- Equation(s):
-- \r_Sel[0]~0_combout\ = r_Sel(0) $ (((r_Count(16) & (r_Count(15) & !\LessThan0~2_combout\))))
...
-- Equation(s):
-- \r_DecPNumber[5]~2_combout\ = (\i_MultOp~input_o\ & (((\r_NumberSign~0_combout\) # (\i_Number[5]~input_o\)))) # (!\i_MultOp~input_o\ & (\i_Number[1]~input_o\ & (!\r_NumberSign~0_combout\)))
...
PORT MAP (
	...
	datab => \i_MultOp~input_o\,
	datac => \r_NumberSign~0_combout\,
...
-- Equation(s):
-- \r_DecPNumber[5]~3_combout\ = (\r_DecPNumber[5]~2_combout\ & (((!\r_NumberSign~0_combout\)) # (!\Add2~10_combout\))) # (!\r_DecPNumber[5]~2_combout\ & (((\r_NumberSign~0_combout\ & !\Add3~2_combout\))))
...
PORT MAP (
	...
	datab => \r_DecPNumber[5]~2_combout\,
	datac => \r_NumberSign~0_combout\,
...
-- Equation(s):
-- \r_DecPNumber[6]~4_combout\ = (\i_MultOp~input_o\ & (((\r_NumberSign~0_combout\) # (\i_Number[6]~input_o\)))) # (!\i_MultOp~input_o\ & (\i_Number[2]~input_o\ & (!\r_NumberSign~0_combout\)))
...
-- Equation(s):
-- \r_DecPNumber[6]~5_combout\ = (\r_NumberSign~0_combout\ & ((\r_DecPNumber[6]~4_combout\ & (!\Add2~12_combout\)) # (!\r_DecPNumber[6]~4_combout\ & ((!\Add3~4_combout\))))) # (!\r_NumberSign~0_combout\ & (((\r_DecPNumber[6]~4_combout\))))
...
PORT MAP (
	...
	datac => \r_NumberSign~0_combout\,
	datad => \r_DecPNumber[6]~4_combout\,
...
-- Equation(s):
-- \r_DecPNumber[7]~6_combout\ = (\i_MultOp~input_o\ & (((\i_Number[15]~input_o\) # (\i_Number[7]~input_o\)))) # (!\i_MultOp~input_o\ & (\i_Number[3]~input_o\ & ((!\i_Number[7]~input_o\))))
...
-- Equation(s):
-- \r_DecPNumber[7]~7_combout\ = (\r_DecPNumber[7]~6_combout\ & (((!\r_NumberSign~0_combout\)) # (!\Add2~14_combout\))) # (!\r_DecPNumber[7]~6_combout\ & (((\r_NumberSign~0_combout\ & !\Add3~6_combout\))))
...
PORT MAP (
	...
	datab => \r_DecPNumber[7]~6_combout\,
	datac => \r_NumberSign~0_combout\,
...
-- Equation(s):
-- \r_DecPNumber[4]~0_combout\ = (\i_MultOp~input_o\ & (((\r_NumberSign~0_combout\)))) # (!\i_MultOp~input_o\ & ((\r_NumberSign~0_combout\ & (!\Add3~0_combout\)) # (!\r_NumberSign~0_combout\ & ((\i_Number[0]~input_o\)))))
...
-- Equation(s):
-- \r_DecPNumber[4]~1_combout\ = (\r_DecPNumber[4]~0_combout\ & (((!\i_MultOp~input_o\)) # (!\Add2~8_combout\))) # (!\r_DecPNumber[4]~0_combout\ & (((\i_Number[4]~input_o\ & \i_MultOp~input_o\))))
...
PORT MAP (
	...
	datab => \r_DecPNumber[4]~0_combout\,
...
-- (\r_DecPNumber[5]~3_combout\ $ (!\r_DecPNumber[7]~7_combout\))))
...
PORT MAP (
	...
	datab => \r_DecPNumber[6]~5_combout\,
	datac => \r_DecPNumber[7]~7_combout\,
...
-- Equation(s):
-- \r_DecPNumber[2]~10_combout\ = (\i_MultOp~input_o\ & ((\i_Number[15]~input_o\ & ((!\Add2~4_combout\))) # (!\i_Number[15]~input_o\ & (\i_Number[2]~input_o\))))
...
-- Equation(s):
-- \r_DecPNumber[1]~9_combout\ = (\i_MultOp~input_o\ & ((\i_Number[15]~input_o\ & (!\Add2~2_combout\)) # (!\i_Number[15]~input_o\ & ((\i_Number[1]~input_o\)))))
...
PORT MAP (
	...
	datab => \i_Number[15]~input_o\,
	datac => \i_MultOp~input_o\,
	datad => \i_Number[1]~input_o\,
	combout => \r_DecPNumber[1]~9_combout\);

-- Location: LCCOMB_X23_Y6_N30
\r_DecPNumber[3]~11\ : cycloneive_lcell_comb
-- Equation(s):
-- \r_DecPNumber[3]~11_combout\ = (\i_MultOp~input_o\ & ((\i_Number[15]~input_o\ & ((!\Add2~6_combout\))) # (!\i_Number[15]~input_o\ & (\i_Number[3]~input_o\))))
...
-- Equation(s):
-- \r_DecPNumber[0]~8_combout\ = (\i_MultOp~input_o\ & ((\i_Number[15]~input_o\ & ((!\Add2~0_combout\))) # (!\i_Number[15]~input_o\ & (\i_Number[0]~input_o\))))
...
-- Equation(s):
-- \DisplayDecoder4|Mux6~0_combout\ = (\r_DecPNumber[2]~10_combout\ & (!\r_DecPNumber[1]~9_combout\ & (\r_DecPNumber[3]~11_combout\ $ (!\r_DecPNumber[0]~8_combout\)))) # (!\r_DecPNumber[2]~10_combout\ & (\r_DecPNumber[0]~8_combout\ & 
-- (\r_DecPNumber[1]~9_combout\ $ (!\r_DecPNumber[3]~11_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \r_DecPNumber[2]~10_combout\,
	datab => \r_DecPNumber[1]~9_combout\,
	datac => \r_DecPNumber[3]~11_combout\,
	datad => \r_DecPNumber[0]~8_combout\,
...
-- Equation(s):
-- \r_IntPNumber[3]~6_combout\ = (\i_MultOp~input_o\ & ((\i_Number[15]~input_o\ & ((!\Add2~22_combout\))) # (!\i_Number[15]~input_o\ & (\i_Number[11]~input_o\))))
...
-- Equation(s):
-- \Add3~14_combout\ = \Add3~13\ $ (!\i_Number[7]~input_o\)
...
-- Equation(s):
-- \r_IntPNumber[3]~7_combout\ = (\r_IntPNumber[3]~6_combout\) # ((\i_Number[7]~input_o\ & (!\Add3~14_combout\ & !\i_MultOp~input_o\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \r_IntPNumber[3]~6_combout\,
	datab => \i_Number[7]~input_o\,
...
-- Equation(s):
-- \r_IntPNumber[0]~0_combout\ = (\r_NumberSign~0_combout\ & (((\i_MultOp~input_o\)))) # (!\r_NumberSign~0_combout\ & ((\i_MultOp~input_o\ & (\i_Number[8]~input_o\)) # (!\i_MultOp~input_o\ & ((\i_Number[4]~input_o\)))))
...
-- Equation(s):
-- \r_IntPNumber[0]~1_combout\ = (\r_NumberSign~0_combout\ & ((\r_IntPNumber[0]~0_combout\ & (!\Add2~16_combout\)) # (!\r_IntPNumber[0]~0_combout\ & ((!\Add3~8_combout\))))) # (!\r_NumberSign~0_combout\ & (((\r_IntPNumber[0]~0_combout\))))
...
-- Equation(s):
-- \r_IntPNumber[2]~4_combout\ = (\r_NumberSign~0_combout\ & (((\i_MultOp~input_o\)))) # (!\r_NumberSign~0_combout\ & ((\i_MultOp~input_o\ & (\i_Number[10]~input_o\)) # (!\i_MultOp~input_o\ & ((\i_Number[6]~input_o\)))))
...
-- Equation(s):
-- \r_IntPNumber[2]~5_combout\ = (\r_NumberSign~0_combout\ & ((\r_IntPNumber[2]~4_combout\ & (!\Add2~20_combout\)) # (!\r_IntPNumber[2]~4_combout\ & ((!\Add3~12_combout\))))) # (!\r_NumberSign~0_combout\ & (((\r_IntPNumber[2]~4_combout\))))
...
PORT MAP (
	...
	datab => \r_NumberSign~0_combout\,
	datac => \r_IntPNumber[2]~4_combout\,
...
-- Equation(s):
-- \r_IntPNumber[1]~2_combout\ = (\i_MultOp~input_o\ & (((\r_NumberSign~0_combout\)))) # (!\i_MultOp~input_o\ & ((\r_NumberSign~0_combout\ & ((!\Add3~10_combout\))) # (!\r_NumberSign~0_combout\ & (\i_Number[5]~input_o\))))
...
-- Equation(s):
-- \r_IntPNumber[1]~3_combout\ = (\i_MultOp~input_o\ & ((\r_IntPNumber[1]~2_combout\ & (!\Add2~18_combout\)) # (!\r_IntPNumber[1]~2_combout\ & ((\i_Number[9]~input_o\))))) # (!\i_MultOp~input_o\ & (((\r_IntPNumber[1]~2_combout\))))
...
-- Equation(s):
-- \DisplayDecoder2|Mux6~0_combout\ = (\r_IntPNumber[3]~7_combout\ & (\r_IntPNumber[0]~1_combout\ & (\r_IntPNumber[2]~5_combout\ $ (\r_IntPNumber[1]~3_combout\)))) # (!\r_IntPNumber[3]~7_combout\ & (!\r_IntPNumber[1]~3_combout\ & (\r_IntPNumber[0]~1_combout\ 
...
-- pragma translate_on
PORT MAP (
	dataa => \r_IntPNumber[3]~7_combout\,
	datab => \r_IntPNumber[0]~1_combout\,
	datac => \r_IntPNumber[2]~5_combout\,
	datad => \r_IntPNumber[1]~3_combout\,
	combout => \DisplayDecoder2|Mux6~0_combout\);

-- Location: LCCOMB_X22_Y6_N24
\o_Segments~12\ : cycloneive_lcell_comb
-- Equation(s):
-- \o_Segments~12_combout\ = (r_Sel(1) & ((r_Sel(0)) # ((\DisplayDecoder2|Mux6~0_combout\)))) # (!r_Sel(1) & (!r_Sel(0) & (\DisplayDecoder4|Mux6~0_combout\)))
...
PORT MAP (
	dataa => r_Sel(1),
	datab => r_Sel(0),
	datac => \DisplayDecoder4|Mux6~0_combout\,
...
-- Equation(s):
-- \r_IntPNumber[6]~10_combout\ = (\i_MultOp~input_o\ & ((\i_Number[15]~input_o\ & ((!\Add2~28_combout\))) # (!\i_Number[15]~input_o\ & (\i_Number[14]~input_o\))))
...
-- Equation(s):
-- \r_IntPNumber[5]~9_combout\ = (\i_MultOp~input_o\ & ((\i_Number[15]~input_o\ & (!\Add2~26_combout\)) # (!\i_Number[15]~input_o\ & ((\i_Number[13]~input_o\)))))
...
-- Equation(s):
-- \r_IntPNumber[7]~11_combout\ = (!\Add2~30_combout\ & (\i_Number[15]~input_o\ & \i_MultOp~input_o\))
...
-- Equation(s):
-- \r_IntPNumber[4]~8_combout\ = (\i_MultOp~input_o\ & ((\i_Number[15]~input_o\ & (!\Add2~24_combout\)) # (!\i_Number[15]~input_o\ & ((\i_Number[12]~input_o\)))))
...
-- Equation(s):
-- \DisplayDecoder1|Mux6~0_combout\ = (\r_IntPNumber[6]~10_combout\ & (!\r_IntPNumber[5]~9_combout\ & (\r_IntPNumber[7]~11_combout\ $ (!\r_IntPNumber[4]~8_combout\)))) # (!\r_IntPNumber[6]~10_combout\ & (\r_IntPNumber[4]~8_combout\ & 
-- (\r_IntPNumber[5]~9_combout\ $ (!\r_IntPNumber[7]~11_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \r_IntPNumber[6]~10_combout\,
	datab => \r_IntPNumber[5]~9_combout\,
	datac => \r_IntPNumber[7]~11_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \DisplayDecoder3|Mux6~0_combout\,
...
-- Equation(s):
-- \DisplayDecoder3|Mux5~0_combout\ = (\r_DecPNumber[5]~3_combout\ & ((\r_DecPNumber[4]~1_combout\ & ((\r_DecPNumber[7]~7_combout\))) # (!\r_DecPNumber[4]~1_combout\ & (\r_DecPNumber[6]~5_combout\)))) # (!\r_DecPNumber[5]~3_combout\ & 
-- (\r_DecPNumber[6]~5_combout\ & (\r_DecPNumber[7]~7_combout\ $ (\r_DecPNumber[4]~1_combout\))))
...
-- Equation(s):
-- \DisplayDecoder1|Mux5~0_combout\ = (\r_IntPNumber[5]~9_combout\ & ((\r_IntPNumber[4]~8_combout\ & ((\r_IntPNumber[7]~11_combout\))) # (!\r_IntPNumber[4]~8_combout\ & (\r_IntPNumber[6]~10_combout\)))) # (!\r_IntPNumber[5]~9_combout\ & 
-- (\r_IntPNumber[6]~10_combout\ & (\r_IntPNumber[7]~11_combout\ $ (\r_IntPNumber[4]~8_combout\))))
...
-- Equation(s):
-- \DisplayDecoder4|Mux5~0_combout\ = (\r_DecPNumber[1]~9_combout\ & ((\r_DecPNumber[0]~8_combout\ & ((\r_DecPNumber[3]~11_combout\))) # (!\r_DecPNumber[0]~8_combout\ & (\r_DecPNumber[2]~10_combout\)))) # (!\r_DecPNumber[1]~9_combout\ & 
-- (\r_DecPNumber[2]~10_combout\ & (\r_DecPNumber[3]~11_combout\ $ (\r_DecPNumber[0]~8_combout\))))
...
-- Equation(s):
-- \DisplayDecoder2|Mux5~0_combout\ = (\r_IntPNumber[3]~7_combout\ & ((\r_IntPNumber[0]~1_combout\ & ((\r_IntPNumber[1]~3_combout\))) # (!\r_IntPNumber[0]~1_combout\ & (\r_IntPNumber[2]~5_combout\)))) # (!\r_IntPNumber[3]~7_combout\ & 
-- (\r_IntPNumber[2]~5_combout\ & (\r_IntPNumber[0]~1_combout\ $ (\r_IntPNumber[1]~3_combout\))))
...
-- Equation(s):
-- \DisplayDecoder1|Mux4~0_combout\ = (\r_IntPNumber[6]~10_combout\ & (\r_IntPNumber[7]~11_combout\ & ((\r_IntPNumber[5]~9_combout\) # (!\r_IntPNumber[4]~8_combout\)))) # (!\r_IntPNumber[6]~10_combout\ & (\r_IntPNumber[5]~9_combout\ & 
-- (!\r_IntPNumber[7]~11_combout\ & !\r_IntPNumber[4]~8_combout\)))
...
-- Equation(s):
-- \DisplayDecoder3|Mux4~0_combout\ = (\r_DecPNumber[6]~5_combout\ & (\r_DecPNumber[7]~7_combout\ & ((\r_DecPNumber[5]~3_combout\) # (!\r_DecPNumber[4]~1_combout\)))) # (!\r_DecPNumber[6]~5_combout\ & (\r_DecPNumber[5]~3_combout\ & 
-- (!\r_DecPNumber[7]~7_combout\ & !\r_DecPNumber[4]~1_combout\)))
...
-- Equation(s):
-- \DisplayDecoder2|Mux4~0_combout\ = (\r_IntPNumber[3]~7_combout\ & (\r_IntPNumber[2]~5_combout\ & ((\r_IntPNumber[1]~3_combout\) # (!\r_IntPNumber[0]~1_combout\)))) # (!\r_IntPNumber[3]~7_combout\ & (!\r_IntPNumber[0]~1_combout\ & 
-- (!\r_IntPNumber[2]~5_combout\ & \r_IntPNumber[1]~3_combout\)))
...
-- Equation(s):
-- \DisplayDecoder4|Mux4~0_combout\ = (\r_DecPNumber[2]~10_combout\ & (\r_DecPNumber[3]~11_combout\ & ((\r_DecPNumber[1]~9_combout\) # (!\r_DecPNumber[0]~8_combout\)))) # (!\r_DecPNumber[2]~10_combout\ & (\r_DecPNumber[1]~9_combout\ & 
-- (!\r_DecPNumber[3]~11_combout\ & !\r_DecPNumber[0]~8_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \DisplayDecoder1|Mux4~0_combout\,
	datab => \o_Segments~14_combout\,
...
-- Equation(s):
-- \DisplayDecoder1|Mux3~0_combout\ = (\r_IntPNumber[4]~8_combout\ & (\r_IntPNumber[6]~10_combout\ $ ((!\r_IntPNumber[5]~9_combout\)))) # (!\r_IntPNumber[4]~8_combout\ & ((\r_IntPNumber[6]~10_combout\ & (!\r_IntPNumber[5]~9_combout\ & 
-- !\r_IntPNumber[7]~11_combout\)) # (!\r_IntPNumber[6]~10_combout\ & (\r_IntPNumber[5]~9_combout\ & \r_IntPNumber[7]~11_combout\))))
...
-- Equation(s):
-- \DisplayDecoder3|Mux3~0_combout\ = (\r_DecPNumber[4]~1_combout\ & (\r_DecPNumber[5]~3_combout\ $ ((!\r_DecPNumber[6]~5_combout\)))) # (!\r_DecPNumber[4]~1_combout\ & ((\r_DecPNumber[5]~3_combout\ & (!\r_DecPNumber[6]~5_combout\ & 
-- \r_DecPNumber[7]~7_combout\)) # (!\r_DecPNumber[5]~3_combout\ & (\r_DecPNumber[6]~5_combout\ & !\r_DecPNumber[7]~7_combout\))))
...
-- Equation(s):
-- \DisplayDecoder2|Mux3~0_combout\ = (\r_IntPNumber[0]~1_combout\ & ((\r_IntPNumber[2]~5_combout\ $ (!\r_IntPNumber[1]~3_combout\)))) # (!\r_IntPNumber[0]~1_combout\ & ((\r_IntPNumber[3]~7_combout\ & (!\r_IntPNumber[2]~5_combout\ & 
-- \r_IntPNumber[1]~3_combout\)) # (!\r_IntPNumber[3]~7_combout\ & (\r_IntPNumber[2]~5_combout\ & !\r_IntPNumber[1]~3_combout\))))
...
-- Equation(s):
-- \DisplayDecoder4|Mux3~0_combout\ = (\r_DecPNumber[0]~8_combout\ & (\r_DecPNumber[2]~10_combout\ $ ((!\r_DecPNumber[1]~9_combout\)))) # (!\r_DecPNumber[0]~8_combout\ & ((\r_DecPNumber[2]~10_combout\ & (!\r_DecPNumber[1]~9_combout\ & 
-- !\r_DecPNumber[3]~11_combout\)) # (!\r_DecPNumber[2]~10_combout\ & (\r_DecPNumber[1]~9_combout\ & \r_DecPNumber[3]~11_combout\))))
...
-- Equation(s):
-- \o_Segments~19_combout\ = (r_Sel(1) & ((\DisplayDecoder2|Mux3~0_combout\) # ((r_Sel(0))))) # (!r_Sel(1) & (((!r_Sel(0) & \DisplayDecoder4|Mux3~0_combout\))))
...
PORT MAP (
	...
	datac => r_Sel(0),
	datad => \DisplayDecoder4|Mux3~0_combout\,
	combout => \o_Segments~19_combout\);

-- Location: LCCOMB_X22_Y6_N0
\o_Segments~20\ : cycloneive_lcell_comb
-- Equation(s):
-- \o_Segments~20_combout\ = (r_Sel(0) & ((\o_Segments~19_combout\ & (\DisplayDecoder1|Mux3~0_combout\)) # (!\o_Segments~19_combout\ & ((\DisplayDecoder3|Mux3~0_combout\))))) # (!r_Sel(0) & (((\o_Segments~19_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \DisplayDecoder1|Mux3~0_combout\,
	datab => \DisplayDecoder3|Mux3~0_combout\,
	datac => r_Sel(0),
	datad => \o_Segments~19_combout\,
...
-- Equation(s):
-- \DisplayDecoder2|Mux2~0_combout\ = (\r_IntPNumber[1]~3_combout\ & (!\r_IntPNumber[3]~7_combout\ & (\r_IntPNumber[0]~1_combout\))) # (!\r_IntPNumber[1]~3_combout\ & ((\r_IntPNumber[2]~5_combout\ & (!\r_IntPNumber[3]~7_combout\)) # 
...
-- Equation(s):
-- \DisplayDecoder1|Mux1~0_combout\ = (\r_IntPNumber[6]~10_combout\ & (\r_IntPNumber[4]~8_combout\ & (\r_IntPNumber[5]~9_combout\ $ (\r_IntPNumber[7]~11_combout\)))) # (!\r_IntPNumber[6]~10_combout\ & (!\r_IntPNumber[7]~11_combout\ & 
-- ((\r_IntPNumber[5]~9_combout\) # (\r_IntPNumber[4]~8_combout\))))
...
-- Equation(s):
-- \DisplayDecoder3|Mux1~0_combout\ = (\r_DecPNumber[5]~3_combout\ & (!\r_DecPNumber[7]~7_combout\ & ((\r_DecPNumber[4]~1_combout\) # (!\r_DecPNumber[6]~5_combout\)))) # (!\r_DecPNumber[5]~3_combout\ & (\r_DecPNumber[4]~1_combout\ & 
...
-- Equation(s):
-- \DisplayDecoder4|Mux1~0_combout\ = (\r_DecPNumber[2]~10_combout\ & (\r_DecPNumber[0]~8_combout\ & (\r_DecPNumber[1]~9_combout\ $ (\r_DecPNumber[3]~11_combout\)))) # (!\r_DecPNumber[2]~10_combout\ & (!\r_DecPNumber[3]~11_combout\ & 
-- ((\r_DecPNumber[1]~9_combout\) # (\r_DecPNumber[0]~8_combout\))))
...
-- Equation(s):
-- \DisplayDecoder2|Mux1~0_combout\ = (\r_IntPNumber[0]~1_combout\ & (\r_IntPNumber[3]~7_combout\ $ (((\r_IntPNumber[1]~3_combout\) # (!\r_IntPNumber[2]~5_combout\))))) # (!\r_IntPNumber[0]~1_combout\ & (!\r_IntPNumber[3]~7_combout\ & 
-- (!\r_IntPNumber[2]~5_combout\ & \r_IntPNumber[1]~3_combout\)))
...
PORT MAP (
	...
	datab => \DisplayDecoder3|Mux1~0_combout\,
	datac => \o_Segments~23_combout\,
	datad => r_Sel(0),
...
-- Equation(s):
-- \o_Segments~30_combout\ = (\o_Segments~24_combout\) # ((!\i_MultOp~input_o\ & (r_Sel(0) $ (!r_Sel(1)))))
...
-- Equation(s):
-- \DisplayDecoder3|Mux0~0_combout\ = (\r_DecPNumber[4]~1_combout\ & ((\r_DecPNumber[7]~7_combout\) # (\r_DecPNumber[5]~3_combout\ $ (\r_DecPNumber[6]~5_combout\)))) # (!\r_DecPNumber[4]~1_combout\ & ((\r_DecPNumber[5]~3_combout\) # 
-- (\r_DecPNumber[6]~5_combout\ $ (\r_DecPNumber[7]~7_combout\))))
...
-- Equation(s):
-- \DisplayDecoder2|Mux0~0_combout\ = (\r_IntPNumber[0]~1_combout\ & ((\r_IntPNumber[3]~7_combout\) # (\r_IntPNumber[2]~5_combout\ $ (\r_IntPNumber[1]~3_combout\)))) # (!\r_IntPNumber[0]~1_combout\ & ((\r_IntPNumber[1]~3_combout\) # 
...
-- Equation(s):
-- \Mux4~2_combout\ = (r_Sel(1) & ((\DisplayDecoder2|Mux0~0_combout\))) # (!r_Sel(1) & (\DisplayDecoder3|Mux0~0_combout\))
...
-- (\r_DecPNumber[2]~10_combout\ $ (\r_DecPNumber[3]~11_combout\))))
...
-- Equation(s):
-- \Mux4~0_combout\ = (r_Sel(1) & ((\i_Number[7]~input_o\))) # (!r_Sel(1) & (\DisplayDecoder4|Mux0~0_combout\))
...
-- Equation(s):
-- \DisplayDecoder1|Mux0~0_combout\ = (\r_IntPNumber[4]~8_combout\ & ((\r_IntPNumber[7]~11_combout\) # (\r_IntPNumber[6]~10_combout\ $ (\r_IntPNumber[5]~9_combout\)))) # (!\r_IntPNumber[4]~8_combout\ & ((\r_IntPNumber[5]~9_combout\) # 
-- (\r_IntPNumber[6]~10_combout\ $ (\r_IntPNumber[7]~11_combout\))))
...
-- Equation(s):
-- \Mux4~1_combout\ = (r_Sel(1) & ((\i_MultOp~input_o\ & ((\DisplayDecoder1|Mux0~0_combout\))) # (!\i_MultOp~input_o\ & (\Mux4~0_combout\)))) # (!r_Sel(1) & (\Mux4~0_combout\ & ((\i_MultOp~input_o\))))
...
-- Equation(s):
-- \Mux4~3_combout\ = (r_Sel(1) & ((r_Sel(0) & ((!\Mux4~1_combout\))) # (!r_Sel(0) & (!\Mux4~2_combout\)))) # (!r_Sel(1) & ((r_Sel(0) & (!\Mux4~2_combout\)) # (!r_Sel(0) & ((!\Mux4~1_combout\)))))
