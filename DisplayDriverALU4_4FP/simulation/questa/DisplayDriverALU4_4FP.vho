...
-- Equation(s):
-- \Mux4~2_combout\ = (!r_Sel(0) & !r_Sel(1))
...
-- Equation(s):
-- \Mux4~3_combout\ = (r_Sel(0) & r_Sel(1))
...
-- Equation(s):
-- \r_IntPNumber[4]~4_combout\ = (\i_MultOp~input_o\ & ((\i_Number[7]~input_o\ & ((!\Add2~24_combout\))) # (!\i_Number[7]~input_o\ & (\i_Number[12]~input_o\))))
...
-- Equation(s):
-- \Add2~30_combout\ = \i_Number[15]~input_o\ $ (\Add2~29\)
...
-- Equation(s):
-- \r_IntPNumber[7]~7_combout\ = (\i_MultOp~input_o\ & ((\i_Number[7]~input_o\ & ((\Add2~30_combout\))) # (!\i_Number[7]~input_o\ & (\i_Number[15]~input_o\))))
...
-- Equation(s):
-- \r_IntPNumber[5]~5_combout\ = (\i_MultOp~input_o\ & ((\i_Number[7]~input_o\ & (!\Add2~26_combout\)) # (!\i_Number[7]~input_o\ & ((\i_Number[13]~input_o\)))))
...
-- Equation(s):
-- \r_IntPNumber[6]~6_combout\ = (\i_MultOp~input_o\ & ((\i_Number[7]~input_o\ & ((!\Add2~28_combout\))) # (!\i_Number[7]~input_o\ & (\i_Number[14]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \r_IntPNumber[4]~4_combout\,
	datab => \r_IntPNumber[7]~7_combout\,
	datac => \r_IntPNumber[5]~5_combout\,
...
-- Equation(s):
-- \r_NumberSign~0_combout\ = (\i_MultOp~input_o\ & ((\i_Number[7]~input_o\))) # (!\i_MultOp~input_o\ & (\i_Number[15]~input_o\))
...
-- Equation(s):
-- \DisplayDecoder2|Mux6~0_combout\ = (\r_IntPNumber[3]~3_combout\ & (\r_IntPNumber[0]~0_combout\ & (\r_IntPNumber[1]~1_combout\ $ (\r_IntPNumber[2]~2_combout\)))) # (!\r_IntPNumber[3]~3_combout\ & (!\r_IntPNumber[1]~1_combout\ & (\r_IntPNumber[2]~2_combout\ 
-- $ (\r_IntPNumber[0]~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \r_IntPNumber[3]~3_combout\,
	datab => \r_IntPNumber[1]~1_combout\,
	datac => \r_IntPNumber[2]~2_combout\,
	datad => \r_IntPNumber[0]~0_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \r_DecPNumber[2]~7_combout\,
	datab => \r_DecPNumber[1]~6_combout\,
	datac => \r_DecPNumber[0]~5_combout\,
...
-- Equation(s):
-- \o_Segments~12_combout\ = (r_Sel(0) & (r_Sel(1))) # (!r_Sel(0) & ((r_Sel(1) & (\DisplayDecoder2|Mux6~0_combout\)) # (!r_Sel(1) & ((\DisplayDecoder4|Mux6~0_combout\)))))
...
-- Equation(s):
-- \r_DecPNumber[7]~9_combout\ = (\i_MultOp~input_o\ & (\i_Number[7]~input_o\ & ((!\Add2~14_combout\)))) # (!\i_MultOp~input_o\ & ((\i_Number[15]~input_o\ & ((!\Add2~14_combout\))) # (!\i_Number[15]~input_o\ & (\i_Number[7]~input_o\))))
...
-- Equation(s):
-- \DisplayDecoder3|Mux6~0_combout\ = (\r_DecPNumber[6]~4_combout\ & (!\r_DecPNumber[5]~3_combout\ & (\r_DecPNumber[7]~9_combout\ $ (!\r_DecPNumber[4]~2_combout\)))) # (!\r_DecPNumber[6]~4_combout\ & (\r_DecPNumber[4]~2_combout\ & 
-- (\r_DecPNumber[5]~3_combout\ $ (!\r_DecPNumber[7]~9_combout\))))
...
-- Equation(s):
-- \o_Segments~25_combout\ = (\o_Segments~13_combout\) # ((!\i_MultOp~input_o\ & (r_Sel(0) $ (!r_Sel(1)))))
...
-- Equation(s):
-- \DisplayDecoder3|Mux5~0_combout\ = (\r_DecPNumber[5]~3_combout\ & ((\r_DecPNumber[4]~2_combout\ & ((\r_DecPNumber[7]~9_combout\))) # (!\r_DecPNumber[4]~2_combout\ & (\r_DecPNumber[6]~4_combout\)))) # (!\r_DecPNumber[5]~3_combout\ & 
-- (\r_DecPNumber[6]~4_combout\ & (\r_DecPNumber[7]~9_combout\ $ (\r_DecPNumber[4]~2_combout\))))
...
-- Equation(s):
-- \DisplayDecoder2|Mux5~0_combout\ = (\r_IntPNumber[3]~3_combout\ & ((\r_IntPNumber[0]~0_combout\ & (\r_IntPNumber[1]~1_combout\)) # (!\r_IntPNumber[0]~0_combout\ & ((\r_IntPNumber[2]~2_combout\))))) # (!\r_IntPNumber[3]~3_combout\ & 
-- (\r_IntPNumber[2]~2_combout\ & (\r_IntPNumber[1]~1_combout\ $ (\r_IntPNumber[0]~0_combout\))))
...
-- (\r_IntPNumber[6]~6_combout\ & (\r_IntPNumber[4]~4_combout\ $ (\r_IntPNumber[5]~5_combout\))))
...
-- Equation(s):
-- \o_Segments~16_combout\ = (r_Sel(0) & ((\o_Segments~15_combout\ & ((\DisplayDecoder1|Mux5~0_combout\))) # (!\o_Segments~15_combout\ & (\DisplayDecoder3|Mux5~0_combout\)))) # (!r_Sel(0) & (((\o_Segments~15_combout\))))
...
-- Equation(s):
-- \DisplayDecoder1|Mux4~0_combout\ = (\r_IntPNumber[7]~7_combout\ & (\r_IntPNumber[6]~6_combout\ & ((\r_IntPNumber[5]~5_combout\) # (!\r_IntPNumber[4]~4_combout\)))) # (!\r_IntPNumber[7]~7_combout\ & (!\r_IntPNumber[4]~4_combout\ & 
-- (\r_IntPNumber[5]~5_combout\ & !\r_IntPNumber[6]~6_combout\)))
...
-- Equation(s):
-- \DisplayDecoder4|Mux4~0_combout\ = (\r_DecPNumber[2]~7_combout\ & (\r_DecPNumber[3]~8_combout\ & ((\r_DecPNumber[1]~6_combout\) # (!\r_DecPNumber[0]~5_combout\)))) # (!\r_DecPNumber[2]~7_combout\ & (\r_DecPNumber[1]~6_combout\ & 
-- (!\r_DecPNumber[0]~5_combout\ & !\r_DecPNumber[3]~8_combout\)))
...
-- Equation(s):
-- \DisplayDecoder3|Mux4~0_combout\ = (\r_DecPNumber[6]~4_combout\ & (\r_DecPNumber[7]~9_combout\ & ((\r_DecPNumber[5]~3_combout\) # (!\r_DecPNumber[4]~2_combout\)))) # (!\r_DecPNumber[6]~4_combout\ & (\r_DecPNumber[5]~3_combout\ & 
-- (!\r_DecPNumber[7]~9_combout\ & !\r_DecPNumber[4]~2_combout\)))
...
-- Equation(s):
-- \DisplayDecoder2|Mux4~0_combout\ = (\r_IntPNumber[3]~3_combout\ & (\r_IntPNumber[2]~2_combout\ & ((\r_IntPNumber[1]~1_combout\) # (!\r_IntPNumber[0]~0_combout\)))) # (!\r_IntPNumber[3]~3_combout\ & (\r_IntPNumber[1]~1_combout\ & 
...
-- Equation(s):
-- \o_Segments~17_combout\ = (r_Sel(0) & ((\DisplayDecoder3|Mux4~0_combout\) # ((r_Sel(1))))) # (!r_Sel(0) & (((r_Sel(1) & \DisplayDecoder2|Mux4~0_combout\))))
...
PORT MAP (
	dataa => r_Sel(0),
	datab => \DisplayDecoder3|Mux4~0_combout\,
	datac => r_Sel(1),
...
PORT MAP (
	...
	datac => \DisplayDecoder4|Mux4~0_combout\,
	datad => \o_Segments~17_combout\,
...
-- Equation(s):
-- \DisplayDecoder2|Mux3~0_combout\ = (\r_IntPNumber[0]~0_combout\ & ((\r_IntPNumber[1]~1_combout\ $ (!\r_IntPNumber[2]~2_combout\)))) # (!\r_IntPNumber[0]~0_combout\ & ((\r_IntPNumber[3]~3_combout\ & (\r_IntPNumber[1]~1_combout\ & 
-- !\r_IntPNumber[2]~2_combout\)) # (!\r_IntPNumber[3]~3_combout\ & (!\r_IntPNumber[1]~1_combout\ & \r_IntPNumber[2]~2_combout\))))
...
-- Equation(s):
-- \DisplayDecoder4|Mux3~0_combout\ = (\r_DecPNumber[0]~5_combout\ & (\r_DecPNumber[2]~7_combout\ $ ((!\r_DecPNumber[1]~6_combout\)))) # (!\r_DecPNumber[0]~5_combout\ & ((\r_DecPNumber[2]~7_combout\ & (!\r_DecPNumber[1]~6_combout\ & 
-- !\r_DecPNumber[3]~8_combout\)) # (!\r_DecPNumber[2]~7_combout\ & (\r_DecPNumber[1]~6_combout\ & \r_DecPNumber[3]~8_combout\))))
...
PORT MAP (
	dataa => r_Sel(0),
	datab => r_Sel(1),
	datac => \DisplayDecoder2|Mux3~0_combout\,
...
-- Equation(s):
-- \DisplayDecoder3|Mux3~0_combout\ = (\r_DecPNumber[4]~2_combout\ & (\r_DecPNumber[5]~3_combout\ $ ((!\r_DecPNumber[6]~4_combout\)))) # (!\r_DecPNumber[4]~2_combout\ & ((\r_DecPNumber[5]~3_combout\ & (!\r_DecPNumber[6]~4_combout\ & 
-- \r_DecPNumber[7]~9_combout\)) # (!\r_DecPNumber[5]~3_combout\ & (\r_DecPNumber[6]~4_combout\ & !\r_DecPNumber[7]~9_combout\))))
...
-- Equation(s):
-- \o_Segments~20_combout\ = (\o_Segments~19_combout\ & ((\DisplayDecoder1|Mux3~0_combout\) # ((!r_Sel(0))))) # (!\o_Segments~19_combout\ & (((r_Sel(0) & \DisplayDecoder3|Mux3~0_combout\))))
...
PORT MAP (
	...
	datac => r_Sel(0),
	datad => \DisplayDecoder3|Mux3~0_combout\,
	combout => \o_Segments~20_combout\);

-- Location: LCCOMB_X22_Y12_N24
\o_Segments~28\ : cycloneive_lcell_comb
-- Equation(s):
-- \o_Segments~28_combout\ = (\o_Segments~20_combout\) # ((!\i_MultOp~input_o\ & (r_Sel(0) $ (!r_Sel(1)))))
...
-- Equation(s):
-- \DisplayDecoder1|Mux2~0_combout\ = (\r_IntPNumber[5]~5_combout\ & (\r_IntPNumber[4]~4_combout\ & (!\r_IntPNumber[7]~7_combout\))) # (!\r_IntPNumber[5]~5_combout\ & ((\r_IntPNumber[6]~6_combout\ & ((!\r_IntPNumber[7]~7_combout\))) # 
...
-- Equation(s):
-- \DisplayDecoder3|Mux2~0_combout\ = (\r_DecPNumber[5]~3_combout\ & (((!\r_DecPNumber[7]~9_combout\ & \r_DecPNumber[4]~2_combout\)))) # (!\r_DecPNumber[5]~3_combout\ & ((\r_DecPNumber[6]~4_combout\ & (!\r_DecPNumber[7]~9_combout\)) # 
...
-- Equation(s):
-- \DisplayDecoder2|Mux2~0_combout\ = (\r_IntPNumber[1]~1_combout\ & (!\r_IntPNumber[3]~3_combout\ & ((\r_IntPNumber[0]~0_combout\)))) # (!\r_IntPNumber[1]~1_combout\ & ((\r_IntPNumber[2]~2_combout\ & (!\r_IntPNumber[3]~3_combout\)) # 
-- (!\r_IntPNumber[2]~2_combout\ & ((\r_IntPNumber[0]~0_combout\)))))
...
-- Equation(s):
-- \o_Segments~21_combout\ = (r_Sel(1) & (((r_Sel(0)) # (\DisplayDecoder2|Mux2~0_combout\)))) # (!r_Sel(1) & (\DisplayDecoder3|Mux2~0_combout\ & (r_Sel(0))))
...
-- Equation(s):
-- \DisplayDecoder4|Mux1~0_combout\ = (\r_DecPNumber[2]~7_combout\ & (\r_DecPNumber[0]~5_combout\ & (\r_DecPNumber[1]~6_combout\ $ (\r_DecPNumber[3]~8_combout\)))) # (!\r_DecPNumber[2]~7_combout\ & (!\r_DecPNumber[3]~8_combout\ & 
-- ((\r_DecPNumber[1]~6_combout\) # (\r_DecPNumber[0]~5_combout\))))
...
-- Equation(s):
-- \DisplayDecoder2|Mux1~0_combout\ = (\r_IntPNumber[1]~1_combout\ & (!\r_IntPNumber[3]~3_combout\ & ((\r_IntPNumber[0]~0_combout\) # (!\r_IntPNumber[2]~2_combout\)))) # (!\r_IntPNumber[1]~1_combout\ & (\r_IntPNumber[0]~0_combout\ & 
...
-- Equation(s):
-- \DisplayDecoder3|Mux1~0_combout\ = (\r_DecPNumber[5]~3_combout\ & (!\r_DecPNumber[7]~9_combout\ & ((\r_DecPNumber[4]~2_combout\) # (!\r_DecPNumber[6]~4_combout\)))) # (!\r_DecPNumber[5]~3_combout\ & (\r_DecPNumber[4]~2_combout\ & 
...
-- Equation(s):
-- \DisplayDecoder1|Mux1~0_combout\ = (\r_IntPNumber[4]~4_combout\ & (\r_IntPNumber[7]~7_combout\ $ (((\r_IntPNumber[5]~5_combout\) # (!\r_IntPNumber[6]~6_combout\))))) # (!\r_IntPNumber[4]~4_combout\ & (!\r_IntPNumber[7]~7_combout\ & 
-- (\r_IntPNumber[5]~5_combout\ & !\r_IntPNumber[6]~6_combout\)))
...
PORT MAP (
	...
	datad => \DisplayDecoder1|Mux1~0_combout\,
...
-- Equation(s):
-- \DisplayDecoder2|Mux0~0_combout\ = (\r_IntPNumber[0]~0_combout\ & ((\r_IntPNumber[3]~3_combout\) # (\r_IntPNumber[1]~1_combout\ $ (\r_IntPNumber[2]~2_combout\)))) # (!\r_IntPNumber[0]~0_combout\ & ((\r_IntPNumber[1]~1_combout\) # 
-- (\r_IntPNumber[3]~3_combout\ $ (\r_IntPNumber[2]~2_combout\))))
...
-- Equation(s):
-- \Mux4~7_combout\ = (\i_MultOp~input_o\ & ((\DisplayDecoder1|Mux0~0_combout\))) # (!\i_MultOp~input_o\ & (\i_Number[15]~input_o\))
...
PORT MAP (
	dataa => \i_Number[15]~input_o\,
	datac => \i_MultOp~input_o\,
	datad => \DisplayDecoder1|Mux0~0_combout\,
	combout => \Mux4~7_combout\);

-- Location: LCCOMB_X23_Y9_N2
\DisplayDecoder4|Mux0~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \DisplayDecoder4|Mux0~0_combout\ = (\r_DecPNumber[0]~5_combout\ & ((\r_DecPNumber[3]~8_combout\) # (\r_DecPNumber[2]~7_combout\ $ (\r_DecPNumber[1]~6_combout\)))) # (!\r_DecPNumber[0]~5_combout\ & ((\r_DecPNumber[1]~6_combout\) # 
...
-- Equation(s):
-- \Mux4~5_combout\ = (r_Sel(1) & (\Mux4~7_combout\)) # (!r_Sel(1) & (((\i_MultOp~input_o\ & \DisplayDecoder4|Mux0~0_combout\))))
...
PORT MAP (
	...
	datab => r_Sel(1),
	datac => \i_MultOp~input_o\,
	datad => \DisplayDecoder4|Mux0~0_combout\,
	combout => \Mux4~5_combout\);

-- Location: LCCOMB_X17_Y20_N2
\Mux4~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \Mux4~6_combout\ = (\Mux4~4_combout\ & (!\Mux4~5_combout\ & (r_Sel(0) $ (!r_Sel(1))))) # (!\Mux4~4_combout\ & ((r_Sel(0) $ (r_Sel(1))) # (!\Mux4~5_combout\)))
